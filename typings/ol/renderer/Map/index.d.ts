declare module 'ol/renderer/Map' {
  ...
  export default class MapRenderer extends Disposable {
    ...
    forEachFeatureAtCoordinate<S, T, U>(coordinate: Coordinate, frameState: FrameState, hitTolerance: number, callback: ((param1: FeatureLike, param2: Layer) => T), thisArg: S, layerFilter: ((param1: Layer) => boolean), thisArg2: U): T;
    forEachLayerAtPixel<S, T, U>(pixel: Pixel, frameState: FrameState, hitTolerance: number, callback: ((param1: Layer, param2: Uint8ClampedArray | Uint8Array) => T), thisArg: S, layerFilter: ((param1: Layer) => boolean), thisArg2: U): T;
    getMap(): PluggableMap;
    hasFeatureAtCoordinate<U>(coordinate: Coordinate, frameState: FrameState, hitTolerance: number, layerFilter: ((param1: Layer) => boolean), thisArg: U): boolean;
