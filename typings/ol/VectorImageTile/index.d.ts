declare module 'ol/VectorImageTile' {
  ...
  export default class VectorImageTile extends Tile {
    constructor(tileCoord: TileCoord, state: TileState, sourceRevision: number, format: FeatureFormat, tileLoadFunction: LoadFunction, urlTileCoord: TileCoord, tileUrlFunction: UrlFunction, sourceTileGrid: TileGrid, tileGrid: TileGrid, sourceTiles: { [key: string]: VectorTile }, pixelRatio: number, projection: Projection, tileClass: VectorTile, handleTileChange: (<T>(this: VectorTile_1<T>, param1: Event) => void), zoom: number);
