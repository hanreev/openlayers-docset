declare module 'ol/source/ImageWMS' {
  ...
  export default class ImageWMS extends ImageSource {
    ...
    un(type: 'imageloadend', listener: (evt: ImageSourceEvent) => void): EventsKey;
    ...
    un(type: 'imageloaderror', listener: (evt: ImageSourceEvent) => void): EventsKey;
    ...
    un(type: 'imageloadstart', listener: (evt: ImageSourceEvent) => void): EventsKey;
