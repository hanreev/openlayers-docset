declare module 'ol/tilegrid/TileGrid' {
  ...
  export default class TileGrid {
    ...
    forEachTileCoordParentTileRange: (tileCoord: TileCoord, callback: ((this: T, param1: number, param2: TileRange) => boolean), opt_this?: T, opt_tileRange?: TileRange, opt_extent?: Extent) => boolean;
    getExtent: () => Extent;
