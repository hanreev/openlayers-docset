declare module 'ol/render/canvas/Replay' {
  ...
  export default class CanvasReplay extends VectorContext {
    ...
    replayHitDetection: (context: CanvasRenderingContext2D, transform: Transform, viewRotation: number, skippedFeaturesHash: { [key: string]: boolean }, opt_featureCallback?: (() => void), opt_hitExtent?: Extent) => T | undefined;
