declare module 'ol/render/canvas/ReplayGroup' {
  ...
  export default class CanvasReplayGroup extends ReplayGroup {
    ...
    finish: () => void;
    forEachFeatureAtCoordinate: (coordinate: Coordinate, resolution: number, rotation: number, hitTolerance: number, skippedFeaturesHash: { [key: string]: boolean }, callback: ((param0: Feature | RenderFeature) => T), declutterReplays: { [key: string]: DeclutterGroup }) => T | undefined;
    getClipCoords: (transform: Transform) => number[];
    getReplays: () => { [key: string]: { [key: ReplayType]: CanvasReplay } };
